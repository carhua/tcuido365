...
#[Route(path: '/busqueda-desaparecido')]
class CasoDesaparecidoSearchController extends BaseController
{
    use TraitUser;
    ...
    public function search(EntityManagerInterface $em): Response
    {
        ...
        return $this->render('caso_desaparecido/search.html.twig', [
    ...
    #[Route(path: '/ajax', name: 'caso_desaparecido_search_ajax', methods: ['POST'])]
