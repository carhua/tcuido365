...
/**
 * @method DenuncianteDesaparecido|null find($id, $lockMode = null, $lockVersion = null)
 * @method DenuncianteDesaparecido|null findOneBy(array $criteria, array $orderBy = null)
 * @method DenuncianteDesaparecido[]    findAll()
 * @method DenuncianteDesaparecido[]    findBy(array $criteria, array $orderBy = null, $limit = null, $offset = null)
 */
class DenuncianteDesaparecidoRepository extends BaseRepository
{
    public function __construct(ManagerRegistry $registry)
    {
        parent::__construct($registry, DenuncianteDesaparecido::class);
    }
